...
function loadStack() {
    ...
    stack.sort((a, b) => {
        ...
        // 次に性別の優先度
        if ((a.genderPriority || 1) !== (b.genderPriority || 1)) {
            return (a.genderPriority || 1) - (b.genderPriority || 1);
        }
        // 次にイメージタグの優先度
        if ((a.imagePriority || 1) !== (b.imagePriority || 1)) {
            return (a.imagePriority || 1) - (b.imagePriority || 1);
        }
        // 最後に画数
        return a['画数'] - b['画数'];
    });
